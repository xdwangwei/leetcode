...
public class _134_GasStation {
     ...
     * 我们可以找到最低点，以它为起点(水平轴)，那么相当于整个折线图向上平移，最低点前半段拼接到后面。
    ...
    /**
     * 贪心思想
     * 如果从i走到j时的油量为负，那么对于任意 i < k < j，从k出发也肯定走不到j，所以我们直接以j+1为起点
     * i走到j油量为负，说明最起码i走到k时的油量是正的，从k走到j油量变负了，那么如果以k为起点，k位置油量为0，那么就不可能走到j了
